...
export default function ChatInput({
  ...
  const supportsImageUpload = Boolean(projectId);
            ...
            {projectId ? (
              <>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-800 hover:bg-gray-50 disabled:opacity-50"
                  title="Upload photos to use on this site"
                >
        ...
        <div className="relative">
          <textarea
            ...
            placeholder={
              isUploading
                ? 'Uploading images…'
                : `${placeholder} Drop photos here or use Add images.`
            }
