...
export default function Header() {
  ...
  // Hide header on chat pages, home, and the workspace dashboard
  const isChatPage = pathname.includes('/chat');
  const isMainPage = pathname === '/' || pathname === '/studio' || pathname.startsWith('/login');
  const isDashboard = pathname.startsWith('/dashboard');

  if (isChatPage || isMainPage || isDashboard) {
    return null;
  }
